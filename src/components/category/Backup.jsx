    ...
    return (
        <div className='categorySection'>
            ...
            <div className="categoryItems">
                {
                    // categoriesData[categortItemsState].products.slice(0,8).map((category,index) => <Product key={index} data={category} />)
                    categoriesData.forEach(category=>category.products.map((categoryProduct,index)=><Product key={index} data={categoryProduct} />))
                }
            </div>
